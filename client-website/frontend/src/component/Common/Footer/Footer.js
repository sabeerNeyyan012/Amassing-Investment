...
import { HEADER_LIST } from '../../V2/NavBar/Constants'
import InvexRoutes from '../../../InvexRoutes'

const LEGAL_LIST = [
  {
    label: 'Terms and Conditions',
    redirect: InvexRoutes.TermsAndConditionPolicy.path,
  },
  {
    label: 'Privacy Policy',
    redirect: InvexRoutes.PrivacyPolicy.path,
  },
  {
    label: 'Refund Policy',
    redirect: InvexRoutes.RefundPolicy.path,
  },
  {
    label: 'Cookie Policy',
    redirect: InvexRoutes.CookiePolicy.path,
  },
]
          ...
          <div className='row'>
              ...
              <div className='footer-content'>
                <a href='javascipt:void(0);' className=''>
                  <img
                    height='54px'
                    src={
                      require('../../Common/Images/image.png').default
                    }
                    alt='logo'
                    className='mb-4'
                  />
            ...
            <div className='col-md-2 col col-sm-6'>
              <div className='footer-links'>
                ...
                <ul>
                  {HEADER_LIST.slice(0, 5).map((header, index) => {
                    return (
                      <li key={index}>
                        <Link to={header.redirect} className=''>
                          {header.label}
                        </Link>
                      </li>
                    )
            ...
            <div className='col-md-2 col col-sm-6'>
              <div className='footer-links'>
                <h6 className=' fw-bold mb-4 '>Pages</h6>
                <ul>
                  {HEADER_LIST.slice(5, 9).map((header, index) => {
                    return (
                      <li key={index}>
                        <Link to={header.redirect} className=''>
                          {header.label}
